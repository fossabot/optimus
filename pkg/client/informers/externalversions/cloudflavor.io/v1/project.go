...
import (
	...
	v1 "github.com/PI-Victor/pipelines/pkg/client/listers/cloudflavor.io/v1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.PipelinesV1().Projects(namespace).List(options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.PipelinesV1().Projects(namespace).Watch(options)
			},
		},
		&cloudflavoriov1.Project{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *projectInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&cloudflavoriov1.Project{}, f.defaultInformer)
}
