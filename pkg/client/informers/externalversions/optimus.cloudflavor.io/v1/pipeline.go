...
import (
	...
	internalinterfaces "github.com/cloudflavor/optimus/pkg/client/informers/externalversions/internalinterfaces"
	v1 "github.com/cloudflavor/optimus/pkg/client/listers/optimus.cloudflavor.io/v1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options meta_v1.ListOptions) (runtime.Object, error) {
				...
				return client.OptimusV1().Pipelines(namespace).List(options)
			},
			WatchFunc: func(options meta_v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.OptimusV1().Pipelines(namespace).Watch(options)
			},
		},
		&optimus_cloudflavor_io_v1.Pipeline{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *pipelineInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&optimus_cloudflavor_io_v1.Pipeline{}, f.defaultInformer)
}
