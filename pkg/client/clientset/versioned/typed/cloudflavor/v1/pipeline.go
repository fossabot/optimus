...
import (
	...
	scheme "github.com/pi-victor/pipelines/pkg/client/clientset/versioned/scheme"
...
type PipelineInterface interface {
	...
	Get(name string, options meta_v1.GetOptions) (*v1.Pipeline, error)
	List(opts meta_v1.ListOptions) (*v1.PipelineList, error)
...
func newPipelines(c *CloudflavorV1Client, namespace string) *pipelines {
	return &pipelines{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *pipelines) Get(name string, options meta_v1.GetOptions) (result *v1.Pipeline, err error) {
	result = &v1.Pipeline{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("pipelines").
...
func (c *pipelines) List(opts meta_v1.ListOptions) (result *v1.PipelineList, err error) {
...
func (c *pipelines) Watch(opts meta_v1.ListOptions) (watch.Interface, error) {
	opts.Watch = true
	return c.client.Get().
		Namespace(c.ns).
		Resource("pipelines").
...
func (c *pipelines) Delete(name string, options *meta_v1.DeleteOptions) error {
...
func (c *pipelines) DeleteCollection(options *meta_v1.DeleteOptions, listOptions meta_v1.ListOptions) error {
	return c.client.Delete().
		Namespace(c.ns).
		Resource("pipelines").
